...
//             SerializedProperty propertyBuilder = property.FindPropertyRelative("m_builder");
//
...
//             float heightBuilderId = EditorGUI.GetPropertyHeight(propertyBuilder);
//
...
//
//             string assetName = Path.GetFileNameWithoutExtension(propertyBuilder.stringValue);
//             string headerLabel = !string.IsNullOrEmpty(assetName) ? assetName : property.displayName;
//             List<Type> arguments = GetArguments(propertyBuilder);
//
...
//
//                     KernelEditorGUIUtility.ResourcesObjectField(rectBuilderId, "Builder", propertyBuilder, typeof(ModuleBuilderAsset));
//
