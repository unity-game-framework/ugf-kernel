...
{
    public class DescriptionLoadAssetCoroutine<TDescription> : Coroutine<TDescription> where TDescription : IDescription
    {
        ...
        protected override IEnumerator Routine()
        {
            ...
            Result = asset.GetDescription<TDescription>();
